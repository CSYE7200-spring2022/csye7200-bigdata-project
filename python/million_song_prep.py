...
def save_rows(chunk_id, rows, save_local=False):
    ...
    save_path = f'processed/{chunk_id}.csv'
...
if __name__ == "__main__":
    ...
    parser.add_argument('num_workers', metavar='N', type=int, help='num_workers', default=1)
    parser.add_argument('worker_id', metavar='i', type=int, help='worker_id', default=0)
    ...
    for letter in letters:
        for root, dirs, files in os.walk('millionsongsubset/'+letter):
            for f in files:
